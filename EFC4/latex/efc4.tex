...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze1-case1-state1}
        \caption{Maze 1: Study case 1}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze1-case1-state2}
        \caption{State 2}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze1-case1-state3}
        \caption{State 3}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze1-case2-state1}
        \caption{Maze 1: Study case 1}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze1-case2-state2}
        \caption{State 2}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze1-case2-state3}
        \caption{State 3}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze2-case1-state1}
        \caption{Maze 1: Study case 1}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze2-case1-state2}
        \caption{State 2}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze2-case1-state3}
        \caption{State 3}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze2-case2-state1}
        \caption{Maze 2: Study case 2}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze2-case2-state2}
        \caption{State 2}
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=3cm]{maze2-case2-state3}
        \caption{State 3}
