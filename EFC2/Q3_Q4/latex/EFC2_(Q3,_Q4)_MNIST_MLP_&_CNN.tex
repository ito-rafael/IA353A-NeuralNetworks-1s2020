...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
  Building wheel for tensorflow-determinism (setup.py) {\ldots} done
    \end{Verbatim}
...
modifications: - encapsulated all code inside a function; - included
seed as function parameter; - included device as parameter (to run on
CPU/GPU); - set NumPy and TensorFlow seed; - removed the `import' lines;
- added `verbose = 0' during training and evaluation; - included a
`print' section; - inserted comments; - commented the part where the
model and its weigths are saved in a file
...
\PY{k}{def} \PY{n+nf}{mlp\PYZus{}train}\PY{p}{(}\PY{n}{device}\PY{p}{,} \PY{n}{seed}\PY{o}{=}\PY{l+m+mi}{42}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{k}{with} \PY{n}{device}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{} getting the dataset}
        \PY{n}{mnist} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{keras}\PY{o}{.}\PY{n}{datasets}\PY{o}{.}\PY{n}{mnist}
        \PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}raw}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}raw}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{x\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)} \PY{o}{=} \PY{n}{mnist}\PY{o}{.}\PY{n}{load\PYZus{}data}\PY{p}{(}\PY{p}{)}
        \PY{n}{x\PYZus{}train\PYZus{}raw}\PY{p}{,} \PY{n}{x\PYZus{}test} \PY{o}{=} \PY{n}{x\PYZus{}train\PYZus{}raw} \PY{o}{/} \PY{l+m+mf}{255.0}\PY{p}{,} \PY{n}{x\PYZus{}test} \PY{o}{/} \PY{l+m+mf}{255.0}
        \PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
        ...
        \PY{n}{x\PYZus{}train}\PY{p}{,} \PY{n}{x\PYZus{}dev}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}dev} \PY{o}{=} \PY{n}{train\PYZus{}test\PYZus{}split}\PY{p}{(}
            \PY{n}{x\PYZus{}train\PYZus{}raw}\PY{p}{,}
            \PY{n}{y\PYZus{}train\PYZus{}raw}\PY{p}{,}
        ...
        \PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
        \PY{c+c1}{\PYZsh{} evaluation in test set}
        ...
        \PY{c+c1}{\PYZsh{} evaluation in training set}
        \PY{n}{\PYZus{}}\PY{p}{,} \PY{n}{accuracy\PYZus{}train} \PY{o}{=} \PY{n}{model}\PY{o}{.}\PY{n}{evaluate}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}raw}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}raw}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{n}{verbose}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
        \PY{c+c1}{\PYZsh{} saving the model and weights}
        \PY{c+c1}{\PYZsh{}model\PYZus{}json = model.to\PYZus{}json()}
        \PY{c+c1}{\PYZsh{}json\PYZus{}file = open(\PYZdq{}model\PYZus{}MLP.json\PYZdq{}, \PYZdq{}w\PYZdq{})}
        ...
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{seed = }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n+nb}{str}\PY{p}{(}\PY{n}{seed}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{; }\PY{l+s+s1}{\PYZsq{}}
            \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{loss = }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}0:.4f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{loss}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{; }\PY{l+s+s1}{\PYZsq{}}
            \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy = }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}0:.4f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{accuracy}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{; }\PY{l+s+s1}{\PYZsq{}}
            \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{accuracy train = }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}0:.4f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{accuracy\PYZus{}train}\PY{p}{)}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
        \PY{k}{return} \PY{n}{loss}\PY{p}{,} \PY{n}{accuracy}\PY{p}{,} \PY{n}{accuracy\PYZus{}train}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{acc\PYZus{}his\PYZus{}mlp\PYZus{}train} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\PY{k}{for} \PY{n}{seed} \PY{o+ow}{in} \PY{n}{seeds}\PY{p}{:}
    \PY{n}{loss}\PY{p}{,} \PY{n}{acc}\PY{p}{,} \PY{n}{acc\PYZus{}train} \PY{o}{=} \PY{n}{mlp\PYZus{}train}\PY{p}{(}\PY{n}{device}\PY{p}{,} \PY{n}{seed}\PY{o}{=}\PY{n}{seed}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} append both loss and accuracy in a list for comparison}
    ...
    \PY{n}{acc\PYZus{}his\PYZus{}mlp\PYZus{}train}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{acc\PYZus{}train}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Accuracy average (training set) = }\PY{l+s+si}{\PYZob{}0:.4f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{acc\PYZus{}his\PYZus{}mlp\PYZus{}train}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\toprule
seed & reference acc & developed acc & dev. acc (train)\tabularnewline
\midrule
\endhead
0 & 0.9797 & 0.9829 & 0.9957\tabularnewline
1 & 0.9775 & 0.9822 & 0.9962\tabularnewline
2 & 0.9821 & 0.9829 & 0.9968\tabularnewline
3 & 0.9800 & 0.9839 & 0.9962\tabularnewline
4 & 0.9801 & 0.9845 & 0.9968\tabularnewline
5 & 0.9800 & 0.9830 & 0.9951\tabularnewline
6 & 0.9786 & 0.9837 & 0.9962\tabularnewline
7 & 0.9783 & 0.9819 & 0.9958\tabularnewline
8 & 0.9795 & 0.9823 & 0.9952\tabularnewline
9 & 0.9789 & 0.9837 & 0.9964\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}cccc@{}}
\toprule
& reference acc & developed acc & dev. acc (train)\tabularnewline
\midrule
\endhead
mean & 0.9795 & 0.9831 & 0.9960\tabularnewline
\bottomrule
\end{longtable}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{acc\PYZus{}his\PYZus{}mlp\PYZus{}train}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{my implementation (training set)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{green}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
...
\PY{k}{def} \PY{n+nf}{cnn\PYZus{}train}\PY{p}{(}\PY{n}{device}\PY{p}{,} \PY{n}{seed}\PY{o}{=}\PY{l+m+mi}{42}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{k}{with} \PY{n}{device}\PY{p}{:}
        ...
        \PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}raw}\PY{p}{,} \PY{n}{y\PYZus{}train\PYZus{}raw}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{n}{x\PYZus{}test}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)} \PY{o}{=} \PY{n}{mnist}\PY{o}{.}\PY{n}{load\PYZus{}data}\PY{p}{(}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} reshape to be [samples][width][height][pixels]}
        \PY{n}{x\PYZus{}train\PYZus{}raw} \PY{o}{=} \PY{n}{x\PYZus{}train\PYZus{}raw}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{x\PYZus{}train\PYZus{}raw}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{x\PYZus{}test} \PY{o}{=} \PY{n}{x\PYZus{}test}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{x\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{,} \PY{l+m+mi}{28}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{x\PYZus{}train\PYZus{}raw}\PY{p}{,} \PY{n}{x\PYZus{}test} \PY{o}{=} \PY{n}{x\PYZus{}train\PYZus{}raw} \PY{o}{/} \PY{l+m+mf}{255.0}\PY{p}{,} \PY{n}{x\PYZus{}test} \PY{o}{/} \PY{l+m+mf}{255.0}
        \PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
        \PY{c+c1}{\PYZsh{} train\PYZhy{}dev split}
...
\PY{n}{acc\PYZus{}his\PYZus{}cnn\PYZus{}train} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\PY{k}{for} \PY{n}{seed} \PY{o+ow}{in} \PY{n}{seeds}\PY{p}{:}
    \PY{n}{loss}\PY{p}{,} \PY{n}{acc}\PY{p}{,} \PY{n}{acc\PYZus{}train} \PY{o}{=} \PY{n}{cnn\PYZus{}train}\PY{p}{(}\PY{n}{device}\PY{p}{,} \PY{n}{seed}\PY{o}{=}\PY{n}{seed}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} append both loss and accuracy in a list for comparison}
    ...
    \PY{n}{acc\PYZus{}his\PYZus{}cnn\PYZus{}train}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{acc\PYZus{}train}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Accuracy average (training set) = }\PY{l+s+si}{\PYZob{}0:.4f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{acc\PYZus{}his\PYZus{}cnn\PYZus{}train}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\midrule
\endhead
0 & 0.9891 & 0.9927 & 0.9961\tabularnewline
1 & 0.9904 & 0.9928 & 0.9966\tabularnewline
2 & 0.9894 & 0.9932 & 0.9961\tabularnewline
3 & 0.9920 & 0.9939 & 0.9969\tabularnewline
4 & 0.9909 & 0.9926 & 0.9962\tabularnewline
5 & 0.9908 & 0.9934 & 0.9971\tabularnewline
6 & 0.9897 & 0.9938 & 0.9968\tabularnewline
7 & 0.9906 & 0.9931 & 0.9966\tabularnewline
8 & 0.9911 & 0.9934 & 0.9962\tabularnewline
9 & 0.9911 & 0.9922 & 0.9963\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
mean & 0.9905 & 0.9931 & 0.9965\tabularnewline
\bottomrule
\end{longtable}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{acc\PYZus{}his\PYZus{}cnn\PYZus{}train}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{my implementation (training set)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{green}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{c+c1}{\PYZsh{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\PY{c+c1}{\PYZsh{} axis label}
\PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Seed used}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Accuracy on test set}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
approaches: - Linear Classifier (EFC1, Q1) - Extreme Learning Machine
(EFC2, Q2) - Multilayer Perceptron (EFC2, Q3) - Convolutional Neural
Network (EFC2, Q4)

    \begin{longtable}[]{@{}ccc@{}}
\toprule
approach & accuracy test & accuracy train\tabularnewline
\midrule
\endhead
Linear & 0.8647 & 0.8575\tabularnewline
ELM & 0.9194 & 0.9175\tabularnewline
MLP & 0.9834 & 0.9960\tabularnewline
CNN & 0.9929 & 0.9965\tabularnewline
\bottomrule
\end{longtable}

    Briefly comments explaining the performance improvement of each
approach: 


\begin{itemize}
\item
  \textbf{Linear:} Base model. Performance level achieved due to closed solution that minimizes the MSE and also due to regularization.
\item
  \textbf{ELM:} Improvements achieved because of the non-linearity added
  to the model (ReLU units). Regularization via ridge regression also
  used.
\item
  \textbf{MLP:} Improvements achieved because now we are training a
  neural network. Instead of choosing random weights values (like in
  ELM), now the model adapt the weights aiming the minimization of the
  error at the output. This is done via error backpropagation.
  Regularization is also used here (early stopping, dropout).
\item
  \textbf{CNN:} Improvements achieved because of the convolutional
  layers. The MLP approach implies that the network will have good
  results only if the pixels of the new input have similar values to
  those ones seen during the training. The convolutional layers are able
  to find features anywhere in the image now, and not to those positions
  specifically found during the training (translational invariance). The
  pooling layers are also important to help the network to find a
  feature in different positions of the image. Finally, the same
  regularization of MLP also takes place here.
\end{itemize}
